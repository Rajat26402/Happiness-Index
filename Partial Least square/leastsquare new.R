...
library(pls)
data1 <- read.csv("D:/VIT Chennai/SEM 6/Essentials of Data Analytics/Codes/Codes/Lasso Regression/2016_new.csv", header=TRUE, stringsAsFactors=FALSE)
head(data1)
set.seed(1)
...
data2 <- read.csv("D:/VIT Chennai/SEM 6/Essentials of Data Analytics/Codes/Codes/Lasso Regression/2017_new.csv", header=TRUE, stringsAsFactors=FALSE)
